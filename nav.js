...
template.innerHTML = `
  <style>
    ...
    .nav-container.open .nav-links {
      max-width: 800px; /* Large enough to fit links */
      opacity: 1;
  ...
  <div class="nav-container">
    ...
    <div class="nav-links">
        <ul>
            ...
            <li><a href="./exports.html">Vfood Export</a></li>
            <li><a href="./imports.html">Vfood Import</a></li>
            <li><a href="./services.html">Kenya Services</a></li>
